BUILD_TARGET:=$(TARGET)$(BUILD_SLIB_SUFFIX)
...
$(foreach src,$(SRCS),$(eval $(call build_obj,$(src),$(BUILD_PREFIX),$(BUILD_CFLAGS))))

$(BUILD_TARGET_FULL): BUILD_LDFLAGS:=$(LDFLAGS) $(BUILD_GLOBAL_LDFLAGS)
$(BUILD_TARGET_FULL): BUILD_AR:=$(BUILD_AR)
$(BUILD_TARGET_FULL): BUILD_RANLIB:=$(BUILD_RANLIB)
